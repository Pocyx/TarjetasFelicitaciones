...
function preload() {
    game.load.image('sky', 'assets/fondo2.jpg');
    game.load.image('ground', 'assets/platform.png');
    game.load.image('star', 'assets/star.png');
    game.load.spritesheet('dude', 'assets/dude.png', 32, 48);
    game.load.spritesheet('enemigo', 'assets/conejo.png', 450, 350);
    game.load.spritesheet('puerta', 'assets/puerta.png');
}
...
function crearPuerta(){
    //enemy
    // The player and its settings
    puerta = game.add.sprite(-50, game.world.height - 1610, 'puerta');
    //  We need to enable physics on the player
...
function crearTexto(){
    text = game.add.text(game.world.centerX, game.world.centerY, "- Level 2 -");
    ...
    textReflect = game.add.text(game.world.centerX, game.world.centerY + 50, "- Level 2 -");
